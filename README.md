...
- ⚙️ Specify the **search parameter file** (`.par`), which can be exported from [SearchGUI](https://compomics.github.io/projects/searchgui.html).
...
- 📂 A **dedicated folder for each search engine**, containing:
  ...
  - These `.par` files can be directly reused in [SearchGUI](https://compomics.github.io/projects/searchgui.html) for further analysis or reproducibility.
