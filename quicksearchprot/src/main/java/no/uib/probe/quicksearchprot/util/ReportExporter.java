...
//            MainUtilities.QSProtWaitingHandler.addOutputMassage("default Variable mod:\t" + optimisedSearchParameter.getSearchParameters() + "  Factor " + referenceFactor);
        ...
        if (searchEngine.getIndex() == Advocate.xtandem.getIndex()) {
            ...
            MainUtilities.QSProtWaitingHandler.addOutputMassage("Noise Suppression:\t" + xtandemParameters.isUseNoiseSuppression() + "  (" + xtandemParameters.getMinPrecursorMass() + ")");
            ...
            MainUtilities.QSProtWaitingHandler.addOutputMassage("Quick Acetyl:\t\t" + xtandemParameters.isProteinQuickAcetyl());
            MainUtilities.QSProtWaitingHandler.addOutputMassage("Quick Pyrolidone:\t" + xtandemParameters.isQuickPyrolidone());
            ...
            MainUtilities.QSProtWaitingHandler.addOutputMassage("Unanticipated Cleavage:\t" + xtandemParameters.isRefineUnanticipatedCleavages());
            MainUtilities.QSProtWaitingHandler.addOutputMassage("Simi-Enzymatic Cleavage:\t" + xtandemParameters.isRefineSemi());
            ...
            MainUtilities.QSProtWaitingHandler.addOutputMassage("Point Mutations:\t\t" + xtandemParameters.isRefinePointMutations());
...
//            myWriter.write("default Variable mod:\t" + optimisedSearchParameter.getSearchParameters() + "  Factor " + referenceFactor);
                ...
                if (searchEngine.getIndex()
                    ...
                    myWriter.write("Noise Suppression:\t" + xtandemParameters.isUseNoiseSuppression() + "  (" + xtandemParameters.getMinPrecursorMass() + ")\n");
                    myWriter.write("Parent isotop exp:\t" + xtandemParameters.getParentMonoisotopicMassIsotopeError() + "\n");
                    myWriter.write("Quick Acetyl:\t\t" + xtandemParameters.isProteinQuickAcetyl() + "\n");
                    myWriter.write("Quick Pyrolidone:\t" + xtandemParameters.isQuickPyrolidone() + "\n");
                    myWriter.write("stP Bias:\t\t" + xtandemParameters.isStpBias() + "\n");

                    myWriter.write("Refinement:\t\t" + xtandemParameters.isRefine() + "\n");
                    myWriter.write("Unanticipated Cleavage:\t" + xtandemParameters.isRefineUnanticipatedCleavages() + "\n");
                    myWriter.write("Simi-Enzymatic Cleavage:\t" + xtandemParameters.isRefineSemi() + "\n");
